class RFile < ActiveRecord::Base
  ...
  validates_attachment_content_type :file, :content_type => ['image/jpeg', 'application/pdf', 'application/zip', 'image/png', 'image/jpg', 'image/gif']
  
  ICONS = {'image/jpeg' => 'doc_types/icon_image.gif',
           'application/pdf' => 'doc_types/icon_pdf.gif',
           'application/zip' => 'doc_types/icon_pdf.gif',
